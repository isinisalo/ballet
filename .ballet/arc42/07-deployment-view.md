...
| DEP-007 | Checkout-local strict-v22 installation | yksi checkout-kohtainen loopback server/UI, SQLite v19 ja yksi saman checkoutin launchd-daemon; random 0600 bearer-token, polling sekä Codex/Copilot CLI:t, ei pairingia tai remote checkoutia |
