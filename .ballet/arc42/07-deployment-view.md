...
| DEP-007 | Checkout-local strict-v24 installation | yksi checkout-kohtainen loopback server/UI, SQLite v22 ja yksi saman checkoutin launchd-daemon; random 0600 bearer-token, polling ja vain Codex CLI, ei pairingia, provider/network/root-valintoja tai remote checkoutia |
