...
| DEP-008 | Checkout-local strict-v25 Action Agents | yksi checkout-kohtainen loopback server/UI, fresh SQLite v23, project-local Action Agent TOMLit, kaksi governance TOMLia ja yksi launchd Codex daemon; ei Action binding -taulua tai APIa |
