...
| TEST-040 | exact v23/v18/v11/v14/v16/v21/v2/v3 contracts, secondary-provider and general Agent removal, State-owned closure, nested Skills, full docs/design/browser gates, make latest and packaged startup smoke |
| TEST-041 | strict ActionExecutionBindingV3 schema and atomic SQLite v21 upsert/cleanup; removed Agent POST/DELETE/execution routes; Codex-only snapshot, both role mismatches, permissions, immutable continuation and responsive UI gates |
...
| EVID-040 | ADR-040 full repository, desktop/narrow browser and fresh SQLite v21 packaged startup evidence |
