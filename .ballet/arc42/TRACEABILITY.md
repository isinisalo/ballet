...
Tämä tiedosto yhdistää hyväksytyn, review- tai draft-tilaisen intentin mitattavaan evidenssiin kopioimatta stable ID:iden omistamaa kanonista sisältöä. Jokaisella `goal-001`–`goal-019` / `REQ-001`–`REQ-019` -parilla on vähintään yksi havaittava QS–ratkaisu–testi–evidenssi-ketju.
