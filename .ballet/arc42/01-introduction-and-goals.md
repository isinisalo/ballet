...
| REQ-024 | goal-024 | Yksi checkout-kohtainen local-only daemon suorittaa Codex/Copilot-CLI:t serverin omistamasta jonosta ilman Computer-, pairing- tai remote-checkout-käsitteitä ja palautuu fail-closed. | QS-038–QS-040 |
