...
> Superseded by [Loop Engineering three-level Dagre](../loop-engineering-three-level-dagre/REVIEW.md). Historical findings below remain immutable audit context.
