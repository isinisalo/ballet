...
| CON-017 | Checkout-local daemon boundary | serveri omistaa runtime/worktree/finalization/evidence-totuuden; daemon omistaa vain readinessin ja CLI-prosessit; loopback+0600 token, strict binding, polling, lease/fencing ja idempotentti terminal outcome estävät authority driftin |
