...
ADR-034:n ja ADR-035:n supersession-listat määrittävät, mitkä aiemmat päätökset tai niiden osat ovat historiallisia. ADR-036 tarkentaa vain aktiivisen UI-projektion. Tässä indeksissä ei ylläpidetä rinnakkaista päätöstekstiä.
