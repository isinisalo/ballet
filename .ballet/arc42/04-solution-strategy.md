...
1. Parse strict v20 project truth and close only approved Use Cases with accepted Goals, ADRs and Constraints.
2. Freeze the closure into Root Snapshot v13 before dispatch.
...
Provider adapters, ExecutionProfiles, worktrees, resource composition, queue/events, SQLite wrapper, HTTP security, SSE and design tokens are adapted as generic primitives. The cut contains no compatibility path.
