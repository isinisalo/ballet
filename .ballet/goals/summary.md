...
- Projektissa on **16 hyväksyttyä Goalia** ja 27 ADR-recordia. ADR-026 hyväksyy Graph-scopeen explicit finite SSP/SMDP -strategian; ADR-023 omistaa säilyvän kolmitasoisen domain/GraphNode-routing-rajan ja ADR-025/027 Job Node -authoringin industrial flow -projektion.
