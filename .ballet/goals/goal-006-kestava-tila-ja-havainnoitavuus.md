...
Ballet säilyttää Environment-, State-, Action-, Agent-, Feedback-, Critic-, Refinement- ja approval-faktat checkout-local SQLite v17:ssa niin, että eteneminen, keskeytys ja lopputulos voidaan selittää prosessin uudelleenkäynnistyksen jälkeen.
...
4. Run Evidence syntyy vain terminal completed Runista ja jokainen sen fakta voidaan johtaa canonical storeista.
