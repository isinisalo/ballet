...
- Providerin outcome-payload säilyy evidenssinä. Sen sisältämä result validoidaan kerran, tallennetaan yhdessä `completed`-statuksen kanssa kanoniseen `StepRun.result`-kenttään ja luetaan takaisin storesta; Transition engine lukee vain tätä persisted, takaisin luettua kenttää.
...
- Pre-release v8 -Run-datalle ei rakenneta compatibility-projektiota tai toista tuloksen kontrollilähdettä.
