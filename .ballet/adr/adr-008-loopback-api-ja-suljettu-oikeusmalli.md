...
- Suoritettavan Stepin luku sallitaan Root Runin worktreessä ja checkout-kohtaisissa eksplisiittisissä vain luku -juurissa.
- Kirjoitus ja komennon työhakemisto sallitaan vain Root Runin worktreessä.
- Verkko sallitaan vain Stepin valitseman ExecutionProfilen eksplisiittisen `networkAccess`-arvon perusteella.
...
- Oikeusennakkotarkistus sitoo ExecutionSpecin valittuun ExecutionProfileen, käyttöoikeuskyvykkyyksiin, HEADiin ja konfiguraatiotiivisteeseen. Palveluntarjoajan asennus-, autentikointi- ja mallivalmiuden omistaa provider-suorituksen ennakkotarkistus.
...
- Step ei voi kesken Runin laajentaa verkkopääsyä, lukujuuria tai kirjoitusaluetta tallennetun politiikan ulkopuolelle.
