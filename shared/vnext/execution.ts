...
export interface ExecutionPromptEvidenceV11 {
  compositionVersion: typeof VNEXT_PROMPT_COMPOSITION_VERSION;
  role: AgentRunRole;
  phase: AgentRunPhase;
  ...
  prompt: string;
  promptSha256: string;
  taskEnvelopeVersion: typeof VNEXT_TASK_ENVELOPE_VERSION;
  taskEnvelopeSha256: string;
  outputSchemaVersion: typeof VNEXT_ROLE_OUTCOME_VERSION;
...
export interface ExecutionSpecV12 {
  version: typeof VNEXT_EXECUTION_SPEC_VERSION;
  taskId: string;
