...
import {
  VNEXT_EXECUTION_SPEC_VERSION,
  VNEXT_PROMPT_COMPOSITION_VERSION,
  VNEXT_ROLE_OUTCOME_VERSION,
  VNEXT_TASK_ENVELOPE_VERSION
} from "../versions.js";
...
export const executionPromptEvidenceV11Schema = z.object({
  compositionVersion: z.literal(VNEXT_PROMPT_COMPOSITION_VERSION),
  ...
  taskEnvelopeVersion: z.literal(VNEXT_TASK_ENVELOPE_VERSION),
  taskEnvelopeSha256: sha256Schema,
  outputSchemaVersion: z.literal(VNEXT_ROLE_OUTCOME_VERSION),
...
export const executionSpecV12Schema = z.object({
  version: z.literal(VNEXT_EXECUTION_SPEC_VERSION),
  taskId: idSchema,
