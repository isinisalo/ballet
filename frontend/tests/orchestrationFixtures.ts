...
import type { ProjectConfigurationV24 } from "@shared/orchestration/environment";
...
export const orchestrationConfig = (): ProjectConfigurationV24 => {
