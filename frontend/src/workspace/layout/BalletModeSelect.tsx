  ...
  return (
    <Select<BalletMode> value={mode} items={balletModes} onValueChange={(next) => { if (next !== null) onChange(next); }}>
      <SelectTrigger
        ...
        title="Ballet"
        className="h-8 w-fit min-w-0 gap-1.5 rounded-lg border-transparent bg-transparent px-2 font-semibold text-sidebar-foreground transition-colors hover:border-sidebar-border/70 hover:bg-sidebar-hover focus-visible:border-sidebar-border/70 focus-visible:bg-sidebar-hover data-[popup-open]:border-sidebar-border/70 data-[popup-open]:bg-sidebar-accent data-[popup-open]:hover:bg-sidebar-accent group-data-[collapsible=icon]:size-8 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-2 group-data-[collapsible=icon]:hover:border-transparent group-data-[collapsible=icon]:hover:bg-sidebar-hover [&>svg:last-child]:hidden hover:[&>svg:last-child]:block focus-visible:[&>svg:last-child]:block data-[popup-open]:[&>svg:last-child]:block group-data-[collapsible=icon]:[&>svg:last-child]:hidden"
      >
