export function BlackHoleArtwork() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="loop-node-artwork-svg" focusable="false">
...
export function SatelliteArtwork() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="loop-node-artwork-svg" focusable="false">
...
export function MeteoriteArtwork() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="loop-node-artwork-svg" focusable="false">
...
export function SpacemanArtwork() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="loop-node-artwork-svg" focusable="false">
