...
import { scheduleWeekdayLabel, scheduleWeekdays, type RecurringJobSchedule } from "./loopSchedulePresentation";

type Weekday = Extract<RecurringJobSchedule, { cadence: "weekly" }>["weekdays"][number];
