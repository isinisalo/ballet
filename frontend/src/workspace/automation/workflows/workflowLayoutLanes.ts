...
import { workflowCanvasLayoutConfig, workflowDirectionHandles, workflowNodeSizes } from "./workflowLayoutConfig";
import { outputEventStackHeight, workflowBranchStackHeight } from "./workflowLayoutSizing";
import type { WorkflowCanvasLayoutNodeDraft, WorkflowDagreEdge, WorkflowLayoutDirection } from "./workflowLayoutTypes";

export function workflowNodeRanks(nodes: WorkflowCanvasLayoutNodeDraft[], edges: WorkflowDagreEdge[]) {
...
export function workflowNodeOrderIndexes(nodes: WorkflowCanvasLayoutNodeDraft[], edges: WorkflowDagreEdge[], direction: WorkflowLayoutDirection) {
...
export function workflowHorizontalLaneYOffsets(
