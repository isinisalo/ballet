...
export function ConfigureToolbar({ label, status, children }: { label?: ReactNode; status?: string; children?: ReactNode }) {
  return <div data-slot="configure-toolbar" role="toolbar" aria-label="Workspace actions" className="sticky top-0 z-20 flex min-h-12 min-w-0 items-center gap-3 overflow-x-auto border-b border-border bg-background/95 px-4 py-1.5 [scrollbar-width:none] backdrop-blur [&::-webkit-scrollbar]:hidden md:px-6">
