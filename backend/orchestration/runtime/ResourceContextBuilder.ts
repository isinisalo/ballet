import type { AgentComposition, ProjectConfigurationV21 } from "../../../shared/orchestration/environment.js";
...
const allCompositions = (config: ProjectConfigurationV21): AgentComposition[] => [
  config.critic.agent,
