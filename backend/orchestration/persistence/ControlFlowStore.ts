...
import type { ControlFlowEventKind, JsonValue } from "../../../shared/orchestration/index.js";
...
export class ControlFlowStore {
  ...
  append(environmentRunId: string, kind: ControlFlowEventKind, detail: ControlFlowDetail, createdAt: string): number {
    return this.connection().transaction(() => {
      ...
      if (advanced.changes !== 1) throw new ConflictError(`Environment Run ${environmentRunId} exhausted its transition limit.`);
