import type { JsonValue, RefinementProposalSeed } from "../../../shared/orchestration/index.js";
...
export const impactActionIds = (value: unknown): string[] => {
  ...
  if (!Array.isArray(actionIds) || actionIds.some((id) => typeof id !== "string")) {
    throw new ConflictError("Refinement impact scope has no exact Action IDs.");
  }
