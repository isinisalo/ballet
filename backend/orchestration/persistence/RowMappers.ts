...
import { rootSnapshotV16Schema } from "../../../shared/orchestration/schemas/runtimeSchemas.js";
...
export const toEnvironmentRun = (value: unknown): StoredEnvironmentRun => {
  ...
  return {
    ...
    branch: row.branch, executionSnapshot: rootSnapshotV16Schema.parse(JSON.parse(row.execution_snapshot_json)),
