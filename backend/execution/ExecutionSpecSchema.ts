...
export const executionSpecSchema = z.object({
  ...
  nodeRunId: z.string(),
  evidence: z.object({
    compositionVersion: z.literal(2), loopId: z.string(), workLoopNodeId: z.string().optional(),
    ...
    prompt: z.string(), promptSha256: sha256Schema, outputSchemaVersion: z.literal(2),
