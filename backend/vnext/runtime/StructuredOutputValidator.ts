import type { AgentRunPhase, AgentRunRole } from "../../../shared/vnext/runtime.js";
import type { CriticOutcome, RefinementOutcome, ValidationOutcome, WorkOutcome } from "../../../shared/vnext/outcomes.js";
import {
  criticOutcomeSchema, refinementOutcomeSchema, validationOutcomeSchema, workOutcomeSchema
} from "../../../shared/vnext/schemas/outcomeSchemas.js";

export type VNextRoleOutcome = ValidationOutcome | WorkOutcome | CriticOutcome | RefinementOutcome;

export const parseVNextStructuredOutput = (
  raw: string,
  expected: { role: AgentRunRole; phase: AgentRunPhase }
): { success: true; outcome: VNextRoleOutcome } | { success: false; error: string } => {
  ...
  return { success: true, outcome: parsed.data as VNextRoleOutcome };
};
