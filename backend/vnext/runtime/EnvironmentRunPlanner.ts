...
export interface VNextProjectDefinitionPort {
  load(): Promise<VNextProjectDefinition>;
}

export interface VNextProviderPreflightPort {
...
export class EnvironmentRunPlanner {
  constructor(
    private readonly projects: VNextProjectDefinitionPort,
    private readonly providers: VNextProviderPreflightPort,
