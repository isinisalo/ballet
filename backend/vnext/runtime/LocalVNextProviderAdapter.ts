import type { ExecutionProfile } from "../../../shared/vnext/environment.js";
...
import type { VNextProviderPreflightPort } from "./EnvironmentRunPlanner.js";
import type { ProviderTerminal, VNextRuntimeProvider } from "./RuntimeProvider.js";
import type { ExecutionSpecV12 } from "../../../shared/vnext/execution.js";

export class LocalVNextProviderAdapter implements VNextRuntimeProvider, VNextProviderPreflightPort {
  ...
  async execute(spec: ExecutionSpecV12, permissions: ProviderPermissionSpec): Promise<ProviderTerminal> {
    if (permissions.approvalPolicy !== "never" || permissions.provider !== spec.runtime.provider) {
      throw new Error("vNext provider permission snapshot differs from the ExecutionSpec.");
    }
