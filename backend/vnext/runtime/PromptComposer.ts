...
import type { ExecutionPromptEvidenceV11 } from "../../../shared/vnext/execution.js";
import type { JsonValue } from "../../../shared/vnext/primitives.js";
import { canonicalJson, sha256 } from "../../../shared/vnext/primitives.js";
import type { RootSnapshotV13 } from "../../../shared/vnext/runtime.js";
...
export const composeVNextPrompt = (input: {
  ...
  return {
    ...
    resources: [
      { kind: "system", origin: "system", id: "ballet-vnext-role-contract", sourceSha256: sha256(SYSTEM_ROLE_CONTRACT) },
...
const section = (name: string, content: string): string => `<<< BALLET VNEXT COMPOSITION V11 · ${name} >>>\n${content}\n<<< END ${name} >>>`;
const evidence = (
