...
import type { ProjectJobSchedule } from "../../../shared/domain/automation.js";
import {
...
type DailyOverrides = Partial<Pick<
  Extract<ProjectJobSchedule, { kind: "recurring" }>,
  "startsOn" | "time" | "timeZone"
>>;

const daily = (overrides: DailyOverrides = {}): ProjectJobSchedule => ({
  kind: "recurring",
  startsOn: "2026-07-12",
  time: "09:00",
