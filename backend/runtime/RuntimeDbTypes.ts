...
export const loopRunRowSchema = z.object({
  ...
  input_json: nullableString, schedule_work_loop_node_id: nullableString, scheduled_for: nullableString,
...
export const repairRequestRowSchema = z.object({
  ...
  evidence_json: nullableString, state_revision_at_request: z.number().int(), routed_loop_edge_id: nullableString,
  routed_target_loop_id: nullableString,
  status: z.enum(["pending", "routed", "completed", "failed", "cancelled"]),
...
export const orchestrationFrameRowSchema = z.object({
  frame_id: z.string(), root_run_id: z.string(), repair_request_id: z.string(), caller_loop_run_id: z.string(),
