...
describe("runtimeBackendReport", () => {
  it("makes provider-default reasoning explicit for models without choices", () => {
    const report = reportFromProbe({ provider: "copilot", command: "copilot", installed: true, compatible: true, authStatus: "ready",
      version: "1", minimumVersion: "1", policyCapabilities: { workspaceWrite: true, networkControl: true, readOnlyRoots: true } }, [
