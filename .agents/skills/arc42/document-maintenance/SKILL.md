...
4. Preserve stable document IDs and truthful status. For ADRs, follow [ballet-adr](../../ballet-adr/SKILL.md): only current three-line records remain, with no status or supersession pointers. Move active links before deleting obsolete ADRs; Git retains their history.
